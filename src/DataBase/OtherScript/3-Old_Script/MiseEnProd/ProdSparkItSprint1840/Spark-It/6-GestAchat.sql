...
----devis achat
update [ERPSettings].[ComponentByRole] set [IsActive]=0 where [IdComponent]='3fc27cec-a320-45b6-8d08-37aae6b474ca' and [IdRole] = 1043
----commande achat
update [ERPSettings].[ComponentByRole] set [IsActive]=0 where [IdComponent]='4e8c5c12-d4fb-429e-a1de-b5664d763c0b' and [IdRole] = 1043
----bl achat
update [ERPSettings].[ComponentByRole] set [IsActive]=0 where [IdComponent]='c680f967-58d5-43c4-859e-0b7eaffdb748' and [IdRole] = 1043
----facture achat
update [ERPSettings].[ComponentByRole] set [IsActive]=0 where [IdComponent]='a3f6721e-4c21-434f-90a4-3ce1da093bd6' and [IdRole] = 1043
----avoir vente
update [ERPSettings].[ComponentByRole] set [IsActive]=0 where [IdComponent]='48b96d0e-8ddc-46b1-97ac-b60c5e04197f' and [IdRole] = 1043
