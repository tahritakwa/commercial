...
---- marwa change document date from Date type to datetime type -----

ALTER TABLE [Sales].[Document] ALTER COLUMN [DocumentDate] DATETIME NOT NULL;
...
GO
PRINT N'Creating [Sales].[DocumentLineNegotiationOptions]...';
...
--houssem 03-06-2020 addscript ESN
...
add   CONSTRAINT [FK_ContractBenefitInKind_BenefitInKind] FOREIGN KEY ([IdBenefitInKind]) REFERENCES [Payroll].[BenefitInKind] ([Id]),
    CONSTRAINT [FK_ContractBenefitInKind_Contract] FOREIGN KEY ([IdContract]) REFERENCES [Payroll].[Contract] ([Id]) ON DELETE CASCADE
...
alter table [ERPSettings].[Traceability] 
 ...
 add [TimeSheetPerHalfDay]    BIT            CONSTRAINT [DF_Company_TimeSheetPerHalfDay] DEFAULT ((1)) NOT NULL,
    ...
    --houssem 03-06-2020 End Script add ESN  
...
-- Nesrin : add LoanAttachementFile column in Loan table 12/02/2020
...
ADD [AllowEditionItemDesignation] BIT NOT NULL DEFAULT ((0));
 --chedi : add tecdoc Brand Name and change code type
GO
ALTER TABLE [Inventory].[Item]
...
-- ghofrane add columns to bank account table
...
---Ghazoua add LineSalaryRule table 
GO
...
ALTER TABLE [RH].[Interview] WITH NOCHECK
	...
	--- chedi derbali: add default and available qty to StockDocument table
...
---yasmine bouraoui: Adding UrlPicture to Item table

ALTER TABLE [Inventory].[Item]
ADD [UrlPicture] NVARCHAR (255) NULL
--- Ghazoua add statePay to ExitEmployee
ALTER TABLE [Payroll].[EmployeeExit]
...
--- Kossi alter table [Treasury][DetailReconciliation] 13/07/2020
GO
...
--- Kossi alter table  [Payment].[Settlement] 17/07/2020
ALTER TABLE [Payment].[Settlement] 
...
--- kossi alter table [Payment].[PaymentSlip] 21/07/2020
...
---Ghazoua add state to ExitEmployeePayLine 20/07/2020
GO
...
--- kossi alter [Payment].[PaymentSlip]
ALTER TABLE [Payment].[PaymentSlip] DROP COLUMN [NumberOfSettlement];

--- kossi alter table [Treasury].[Reconciliation] 24/07/2020
ALTER TABLE [Treasury].[Reconciliation]
...
-- chedi add columns to address and tiers for crm 05/08/2020
GO
PRINT N'Altering [Sales].[Tiers]...';
...
GO
PRINT N'Altering [Shared].[Contact]...';
...
ALTER TABLE [Payroll].[LeaveType] ADD [Worked] BIT NULL;
ALTER TABLE [RH].[TimeSheetLine] ADD [Worked] BIT NULL;

--- Donia change worked in leavetype to not null and add default value 28/10/2020
ALTER TABLE [Payroll].[LeaveType] ALTER COLUMN [Worked] BIT NOT NULL;
...
ALTER TABLE [Payroll].[ExitActionEmployee] DROP CONSTRAINT [DF_ExitActionEmployee_Verify_Action]
ALTER TABLE [Payroll].[ExitActionEmployee] DROP COLUMN [Verify_Action]
ALTER TABLE [Payroll].[ExitActionEmployee] ADD  [Verify_Action] BIT CONSTRAINT [DF_ExitActionEmployee_Verify_Action] DEFAULT ((0)) NOT NULL
ALTER TABLE [Payroll].[ExitEmailForEmployee] DROP CONSTRAINT [FK_ExitEmailForEmployee_EmployeeExit]
...
-- Amine: Add IsAssigned state column empoyeeTeam 26/11/2020
...
-- Amine : change the AssignmentPercentage not null value
	 ALTER TABLE [Payroll].[EmployeeTeam]
...
ALTER TABLE [Payroll].[Attendance]
    ADD [AdditionalHourOne] FLOAT (53) NOT NULL,
        [AdditionalHourTwo] FLOAT (53) NOT NULL,
        [AdditionalHourThree] FLOAT (53) NOT NULL,
        [AdditionalHourFour] FLOAT (53) NOT NULL;
		
--- Youssef add new table documentTaxeResume and add two column TaxeValueWithCurrency and TaxeValueWithCurrency into DocumentTaxeLine 11/01/2021
ALTER TABLE [Sales].[DocumentLineTaxe]
...
GO
ALTER TABLE [Payroll].[ExitEmployeeLeaveLine]
    ADD [TotalTakenPerYear] FLOAT (53) NOT NULL,
        [AcquiredPerYear]   FLOAT (53) NOT NULL,
        [Year]              INT        NOT NULL,
        [BalancePerYear]    FLOAT (53) NOT NULL;
GO
ALTER TABLE [Payroll].[ExitEmployeeLeaveLine]
...
-- Marwa : delete unicity of zipCode----
...
-- Update leave balance detail 26/02/2021

DROP TABLE [Payroll].[LeaveBalanceRemaining]
...
CREATE TABLE [Payroll].[LeaveBalanceRemaining] (
    ...
    [TransactionUserId]      INT            NULL,
    [DeletedToken]           NVARCHAR (MAX) NULL,
    [RemainingBalanceDay]    FLOAT (53)     DEFAULT ((0)) NOT NULL,
    [RemainingBalanceHour]   FLOAT (53)     DEFAULT ((0)) NOT NULL,
    [CumulativeTakenDay]     FLOAT (53)     DEFAULT ((0)) NOT NULL,
    [CumulativeTakenHour]    FLOAT (53)     DEFAULT ((0)) NOT NULL,
    [CumulativeAcquiredDay]  FLOAT (53)     DEFAULT ((0)) NOT NULL,
    [CumulativeAcquiredHour] FLOAT (53)     DEFAULT ((0)) NOT NULL,
    CONSTRAINT [PK_LeaveBalanceRemaining] PRIMARY KEY CLUSTERED ([Id] ASC),
    CONSTRAINT [FK_LeaveBalanceRemaining_Employee] FOREIGN KEY ([IdEmployee]) REFERENCES [Payroll].[Employee] ([Id]),
    CONSTRAINT [FK_LeaveBalanceRemaining_LeaveType] FOREIGN KEY ([IdLeaveType]) REFERENCES [Payroll].[LeaveType] ([Id]));
...
--- Donia : update country column in bank account 05/05/2021
...
--- kossi add IsFromGarage to Item 18/05/2021
ALTER TABLE [Inventory].[Item] ADD [IsFromGarage] bit NULL;
...
--- Donia add on cascade to [ItemVehicleBrandModelSubModel] 04/06/2021
...
--- Ghazoua add CreationDate and UpdatedDate in item 07/06/2021
...
--- Ghofrane : add constraint to category table 03/12/2021
