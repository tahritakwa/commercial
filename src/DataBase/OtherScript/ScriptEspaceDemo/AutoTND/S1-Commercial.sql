...
BACKUP DATABASE Ref_Commercil_Auto_TND
TO DISK = 'C:\backupdatabase\Ref_Commercil_Auto_TND'
GO
...
RESTORE DATABASE @databaseName FROM DISK = 'C:\backupdatabase\Ref_Commercil_Auto_TND'
