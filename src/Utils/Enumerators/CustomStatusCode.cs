...
{
    /// <summary>
    ///  Contains the values of custom status codes .
    ///  complement of HTTP status code
    ...
    /// 5XX Codes: Server Error codes.Tells the client that something went wrong on the server's side, so that the client may attempt the request again, possibly at a later tim
    /// </summary>
    public enum CustomStatusCode
    {
        ...
        /// <summary>
        /// This exception will be handled when sending invalid token
        /// </summary>
        InvalidToken = 222,
        ...
        GetSuccessfull = 213,
        /// <summary>
        /// Get with predicate success code
        /// </summary>
        GetPredicateSuccessfull = 214,
        /// <summary>
        /// Get by Id sucess code
        /// </summary>
        GetByIdSuccessfull = 215,
        /// <summary>
        /// Validation sucess code
        /// </summary>
        SuccessValidation = 216,
        /// <summary>
        ...
        /// </summary>
        CandidateEmailIsAlreadyEmployeeEmail = 812,
        /// <summary>
        ...
        /// <summary>
        /// This exception will be handled when start and end date are not valide
        /// </summary>
        ...
        /// </summary>
        ItemAlreadyExistsInWarehouse = 932,
        /// <summary>
        /// This exception will be handled when the settelement date is invalid
        /// </summary>
        ...
        #region Auto code range: 1000-3000
        /// <summary>
        /// This exception will be handled when invalid license
        /// </summary>
        InvalidLicense = 1000,
        /// <summary>
        /// This exception will be handled when license maximum user nomber violated
        /// </summary>
        ...
        /// <summary>
        /// This exception will be handled when validate doc contains item exist in provisonal inventory
        /// </summary>
        ...
        /// This exception will be handled when adding btob doc with unsynchronized user 
        /// </summary>
        UserNotSynchronized = 2008,
        /// <summary>
        ...
        #region ESN code range: 3001-5000
        ...
        /// <summary>
        /// This exception will be handled when FormManager and FormCollaborator aren't done
        /// </summary>
        CannotCloseReviewWithoutDoneFormOfCollaboratorAndManager = 3062,
        /// <summary>
        ...
        /// <summary>
        /// This exception will be handled when the user tries to refuse his request
        /// </summary>
        ConnectedUserCannotRefuseHisRequest = 3064,
        /// <summary>
        /// This exception will be handled when the user tries to add candidate who is accepted in an offer
        /// </summary>
        CannotAddCandidateWithAcceptedOfferToNewCandidacy = 3065,
        /// <summary>
        /// This exception will be handled when the user tries to set resignation deposit date before hiring date
        /// </summary>
        CannotAddResignationDepositDateBeforeHiringDate = 3066,
        ...
        /// This exception will be handled when there is no confirmed interview in review
        /// </summary>
        CannotCloseReviewWithoutConfirmedInterview = 3069,
        /// <summary>
        /// This exception will be handled when add document line adding generate document
        /// </summary>
        AddDocumentLineToNotExistingDocument = 3071,
        ...
        /// <summary>
        /// When attempt to update entity associate with closed session
        /// </summary>
        ...
        /// <summary>
        /// Circular relationship between this salary structure and its parent structure 
        /// </summary>
        ...
        /// <summary>
        /// this exception is generated when we try to pass a settlement to pay the last unpaid financial commitment without paying the withholding tax
        /// </summary>
        unpaidWithholdingTax = 8001,
        /// <summary>
        /// this exception is thrown when user delete paymentSlip which state is not provisional
        /// </summary>
        ...
        #region B2B plage de code: 9001-10000
        /// <summary>
        /// this exception is generated when connectiong with wrong Email
        /// </summary>
        WRONG_EMAIL = 9001,
        #endregion
