...
namespace Services.Specific.ErpSettings.Classes
{
    ...
    public class ServiceCodification : Service<CodificationViewModel, Codification>, IServiceCodification
    {
        public ServiceCodification(IRepository<Codification> entityRepo, IUnitOfWork unitOfWork,
          ICodificationBuilder entityBuilder,
