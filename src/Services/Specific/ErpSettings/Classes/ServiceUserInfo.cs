...
namespace Services.Specific.ErpSettings.Classes
{
    ...
    public class ServiceUserInfo : Service<UserInfoViewModel, UserInfo>, IServiceUserInfo
    {
        public ServiceUserInfo(IRepository<UserInfo> entityRepo, IUnitOfWork unitOfWork,
          IUserInfoBuilder entityBuilder,
