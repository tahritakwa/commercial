...
namespace Web.Jobs.EmplyeeExitJobs
{
    public class SendAlertMaterialRecoveryMailJob
    {
        #region fileds
        /// <summary>
        /// Default DbSettings
        ...
        /// Logger
        /// </summary>
        private readonly ILogger<SendAlertMaterialRecoveryMailJob> _logger;
        /// <summary>
        /// _serviceProvider
        /// </summary>
        ...
        public SendAlertMaterialRecoveryMailJob(IOptions<AppSettings> appSettings, ILogger<SendAlertMaterialRecoveryMailJob> logger,
        ...
        public void StartJob()
        {
            ...
            foreach (DbSettings dbSettings in _dbConnectionSettings)
            {
                try
                {
                    ...
                    {
                        const string interfaceName = "Application.Services.PayRoll.Interfaces.IServiceEmployeeExit";
                        ...
                        IServiceExitEmployee serviceEmployeeExit = (IServiceExitEmployee)scope.ServiceProvider.GetRequiredService(Type.GetType(assemblyInterface));
                        serviceEmployeeExit.SendMaterialRecoveryNotification(generatedConnectionString, _smtpSettings);
                    }
                }
                catch (Exception e)
                {
                    ExceptionLogger exceptionLogger = new ExceptionLogger(_logger);
                    exceptionLogger.ExceptionObject(typeof(SendAlertMaterialRecoveryMailJob).Name, e);
                }
            }
        }
    }
