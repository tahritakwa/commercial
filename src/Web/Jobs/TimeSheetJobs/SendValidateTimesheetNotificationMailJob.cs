...
{
    public class SendValidateTimesheetNotificationMailJob
    {
        #region fileds
        /// <summary>
        /// Default DbSettings
        ...
        /// Logger
        /// </summary>
        private readonly ILogger<SendValidateTimesheetNotificationMailJob> _logger;
        /// <summary>
        /// _serviceProvider
        /// </summary>
        ...
        public SendValidateTimesheetNotificationMailJob(IOptions<AppSettings> appSettings, ILogger<SendValidateTimesheetNotificationMailJob> logger,
            ...
            foreach (DbSettings dbSettings in _dbConnectionSettings)
            {
                try
                {
                    using (var scope = _serviceProvider.CreateScope())
                    {
                        ...
                        serviceTimeSheetJobs.SendValidateTimeSheetNotification(generatedConnectionString, _smtpSettings);
                    }
                }
                catch (Exception e)
                {
                    ExceptionLogger exceptionLogger = new ExceptionLogger(_logger);
                    exceptionLogger.ExceptionObject(typeof(SendValidateTimesheetNotificationMailJob).Name, e);
                }
            }
        }
    }
